    ...
    const handleJoinTeam = async () => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                if (data.type === "TEAM_FULL") {
                    toast.error("Team is Full", {
                        description: "This team already has 4 members. Please ask your team leader to create a new team or join a different team."
                    })
                } else if (data.type === "DEPARTMENT_MISMATCH") {
                    toast.error("Department Mismatch", {
                        description: `This team is for ${data.teamDepartment} students. Your department: ${data.yourDepartment}.`
                    })
